        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="Clustalo">
                <div class="resume-section-content">
                    ...
                    <p> Here you can perform a multiple sequence alignment using Clustal Omega. You can enter sequences in FASTA format, UniProt IDs, or upload a FASTA file. 
                        The results will be displayed in the selected format.
                        Please, use only one type of input (if not, you will be redirected to this screen again).</p>
